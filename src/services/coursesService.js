...
export async function assignRfcardsToCourse(course_id) {                                  // gán tất cả thẻ cho tất cả học viên trong khóa học
  const apiEndPointAssignRfcardsToCourse = `courses/${course_id}/rfcards`;
  return http.post(apiEndPointAssignRfcardsToCourse);
}